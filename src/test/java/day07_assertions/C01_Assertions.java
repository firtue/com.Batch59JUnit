...
public class C01_Assertions {
    ...
    3 farklı test hethod'u oluşturarak asağıdaki görevleri yapın

    1- Url'nin amazon kelimesini içerdiğini test edin
    2- title'ın facebook kelimesini içermediğini test edin
