...
public class C03_IstenenWebElementSS extends TestBase {
    ...
    public void webElementSS() throws IOException {
        ...
        // amazon'a gidip Nutella aratalim ve sonuc sayisinin oldugu web elementi'nin fotografini cekelim
        ...
        File sonucYaziElementSS= new File("target/ekranGoruntuleri/sonucYasisiSS.jpeg");
